...
School of Linguistics and Applied Language Studies (LALS)\
...
-- Co-Editor (with Nancy Bell) of [*Language Play and Creativity* Monograph Series](https://www.degruyterbrill.com/serial/lpc-b/html) (2026--present)

-- Director of Language Sciences Program \@ VUW (2026--Present)

-- Convener of [LALS leaRning Group](https://www.stephenskalicky.com/r/index.html) (2022--present)

-- Executive Committee, University Staff Club (2022--Present)

-- Review Panel Member: [Australasian Humour Studies Network (AHSN)](https://ahsnhumourstudies.org/) (2024--present)

-- Guest Editor of Special Issue *Leveraging Computational and Digital Approaches to Examine Figurative and Humorous Language* in *Digital Studies in Language and Literature* (2026) 

***Previous*** 

-- Convener of the [32nd Australasian Humour Studies Network Conference](https://ahsnhumourstudies.org/annual-conference/) (2026) 

-- Director of LALS PhD Program (2024--2026) 

-- Editor: [*New Zealand Studies in Applied Linguistics*](https://www.alanz.org.nz/journal/) (2023--2026)

-- Review Board Member, VUW University Human Ethics Committee (2022--2023)

-- LALS Representative: Faculty Academic Committee, Faculty of Humanities and Social Science (2020--2023) 

-- LALS Seminar Series Coordinator (2019--2022)


***Editorial Boards***

-- *Journal of Second Language Writing* (Quantitative methods reviewer)
...
- **Skalicky, S**. (April 28, 2026). Shower thoughts: What is irony? Radio New Zealand (RNZ) Nights with Emile Donovan. [RNZ Link](https://www.rnz.co.nz/national/programmes/nights/audio/2019032784/shower-thoughts-what-is-irony)

-   **Skalicky, S**. (November 30, 2025). Should we teach AI to be funny? TVNZ Q+A feature segment with Whena Owen. [YouTube](https://youtu.be/GmlQHx_FA4M?si=w1K0AIBHI6pDLUZ3); [TVNZ](https://www.tvnz.co.nz/shows/q-and-a/clips/should-we-teach-ai-to-be-funny)
...
-   Chan, N.C.L, **Skalicky, S**, & Siyanova-Chanturia, A. (September, 2026). Capturing L1 and L2 irony processing through action-dynamics: Insights from mouse-tracking. Paper presented at the 9th International Conference on Figurative Language and Thought (FTL 9). Valencia, Spain.

## 2025

-   Chan, N.C.L, **Skalicky, S**, & Siyanova-Chanturia, A. (November, 2025). Self-perceptions of English sarcasm use by L1 English speakers and L2 English speaker of Cantonese and Mandarin L1 Backgrounds. Paper presented at the New Zealand Linguistic Society 2025 Conference, Wellington, New Zealand.

-   **Skalicky, S**. (October, 2025). Satire as fictional situational irony. Paper presented at The Figure of Irony Revisted 2025 Workshop, Virtual Workshop.
...
-   Chan, N.C.L., Siyanova-Chanturia, A., & **Skalicky, S**. (February, 2025). How do L1 and L2 speakers of English comprehend familiar English phrases used ironically? Paper presented at the 31st Annual Conference of the Australasian Humour Studies Network (AHSN), Adelaide, Australia.
...
### Marsden Fund Council Fast-Start Grant (\$360,000 NZD; 2026-2029)

-   An ironic frame of mind: Investigating the central role of irony in human cognition
-   Investigators: **Skalicky, Stephen** (PI)
-   Royal Society Te Apārangi, Aoterora New Zealand
...
-   Introduction to Computational Linguistics (2021--present)
    -   *Second year undergraduate introduction to Python and natural language processing.*
-   Foundations of Cognitive Science (2025--present)
    -   *Second year undergraduate course on cognitive science; I teach three modules related to humour and irony*
-   Psycholinguistics (starting 2026)
    -   *Third year undergraduate course learning psycholinguistic theory, method, and analysis.*
-   Language and Creativity (2021)
    -   *Third year undergraduate special topic exploring figurative and creative language.*

## Postgraduate (Taught Masters)

-   Exploring grammar using corpus linguistics (2019--2023)
    -   *Learning corpus linguistic methods to analyse lexico-grammatical structures*
-   Second language acquisition (2019--present)
    -   *Introduction to second language acquisition theory and practice.*

## PhD Supervision

-   Currently Supervising: 9 PhD students
-   Graduated: 3 PhD students

## **Workshops & Short Courses**

Skalicky, S. (December, 2024). Learning NLP with Python in 90 Minutes: Colab, NLTK and spaCy. Part of the Vocab\@Vic 2023 Summer School, Wellington, New Zealand).

Skalicky, S. (June, 2023). Intro to Natural Language Processing using Python. Beginner level tutorial, ResBaz Research Bazaar Aotearoa 2023.

Skalicky, S. (November, 2022). Introduction to Python's Natural Language Toolkit for textual analysis. ResBaz Beginner level tutorial, Research Bazaar Aotearoa 2022.
